...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表' AUTO_INCREMENT=144 ;
...
INSERT INTO `onethink_bookshell` (`id`, `title`, `description`, `link_id`, `cover_id`, `update_time`) VALUES
(1, '123', '123', 1, 2, 1392561543);
...
(2, 1, 'document_center', '文档中心', 1, '', 0, 0, 2, 2, 0, 0, 0, 1, 0, 0, 53, 0, 0, 0, 1391043840, 1392447774, 1),
(3, 1, '', '123123', 1, '', 0, 0, 2, 1, 0, 0, 0, 1, 0, 0, 5, 0, 0, 0, 1391045400, 1392009535, 1),
(4, 1, 'experienc', '个人经历', 1, '个人经历的展示', 0, 0, 2, 2, 0, 0, 0, 1, 0, 0, 10, 0, 0, 0, 1392549480, 1392549662, 1);
...
(1, 'admin', 0, '0000-00-00', '', 20, 4, 0, 1392205938, 2130706433, 1392481089, 1);
...
(1, 'admin', '1f5bfd93891c766f8c0e1234b77e3e47', '917647288@qq.com', '', 1392205938, 2130706433, 1392481089, 2130706433, 1392205938, 1);
